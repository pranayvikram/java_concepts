...
/* 
  A functional interface is an informative annotation type used to indicate that 
  an interface type declaration is intended to be a functional interface as defined by the Java Language Specification. 
  ...
  not a FunctionalInterfaceannotation is present on the interface declaration.
 */

@FunctionalInterface
public interface GreetingFunctionInterface {
